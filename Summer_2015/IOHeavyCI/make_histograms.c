...
void make_histograms()
{
	...
	t->SetMarkerStyle(3);
	t->SetMarkerColor(1);
	t->Draw("ReadTime:BufferSize", "ConcurrentReads==1");
	...
	t->SetMarkerStyle(3);
	t->SetMarkerColor(2);
	t->Draw("ReadTime:BufferSize", "ConcurrentReads==3");
	
	//In Second Slot have Time vs. Buffer for 3 Concurrent Reads
	c->cd(3);
	t->SetMarkerStyle(4);
	t->SetMarkerColor(1);
	t->Draw("ReadTime:BufferSize", "ConcurrentReads==6");
	
	//In Second Slot have Time vs. Buffer for 3 Concurrent Reads
	c->cd(4);
	t->SetMarkerStyle(4);
	t->SetMarkerColor(2);
	t->Draw("ReadTime:BufferSize", "ConcurrentReads==10");
